...
ckan.lib.search.query.QUERY_FIELDS = "name^4 title^4 title_th^4 title_icu^4 tags^2 groups^2 text text_th text_icu"
...
class Odm_Dataset_ExtPlugin(Odm_Dataset_ExtMixinPlugin):
    ...
    def get_helpers(self):
        ...
        return {
            ...
            'convert_flask_multidict_to_dict_for_params': helpers.convert_flask_multidict_to_dict_for_params
        }
    ...
    def before_index(self, pkg_dict):
        ...
        try:
            pkg_dict['odm_language_list'] = json.loads(
                pkg_dict.get('odm_language', pkg_dict.get('MD_DataIdentification_language', '[]')))
